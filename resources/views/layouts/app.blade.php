    ...
    >
        ...
        <div class="flex items-center gap-3 h-16 px-5 border-b border-slate-100 flex-shrink-0">
            <a href="{{ route('home') }}" class="flex items-center gap-2 flex-shrink-0">
                <img src="/logo.svg" alt="EduBridge" class="h-8 w-auto">
            </a>
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
            ...
            @if($role === 'student')
                ...
                <x-sidebar-link href="{{ route('student.notebook.index') }}" :active="request()->routeIs('student.notebook*')">
                ...
                <x-sidebar-link href="{{ route('student.wishlist.index') }}" :active="request()->routeIs('student.wishlist*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z"/></x-slot>
                    Wishlist
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('student.notes.index') }}" :active="request()->routeIs('student.notes*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487 18.549 2.799a2.121 2.121 0 1 1 3 3L19.862 7.487M16.862 4.487 9 12.349V15h2.651l7.862-7.862M16.862 4.487 19.862 7.487"/></x-slot>
                    My Notes
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('student.refunds.index') }}" :active="request()->routeIs('student.refunds*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3"/></x-slot>
                    Refunds
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('student.announcements.index') }}" :active="request()->routeIs('student.announcements.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M10.34 3.94c.09-.542.56-.94 1.11-.94h1.093c.55 0 1.02.398 1.11.94l.149.894c.07.424.384.764.78.93.398.164.855.142 1.205-.108l.737-.527a1.125 1.125 0 0 1 1.45.12l.773.774c.39.389.44 1.002.12 1.45l-.527.737c-.25.35-.272.806-.107 1.204.165.397.505.71.93.78l.893.15c.543.09.94.56.94 1.11v1.094c0 .55-.397 1.02-.94 1.11l-.894.149c-.424.07-.764.383-.929.78-.165.398-.143.854.107 1.204l.527.738c.32.447.269 1.06-.12 1.45l-.774.773a1.125 1.125 0 0 1-1.449.12l-.738-.527c-.35-.25-.806-.272-1.203-.107-.397.165-.71.505-.781.929l-.149.894c-.09.542-.56.94-1.11.94h-1.094c-.55 0-1.019-.398-1.11-.94l-.148-.894c-.071-.424-.384-.764-.781-.93-.398-.164-.854-.142-1.204.108l-.738.527c-.447.32-1.06.269-1.45-.12l-.773-.774a1.125 1.125 0 0 1-.12-1.45l.527-.737c.25-.35.273-.806.108-1.204-.165-.397-.505-.71-.93-.78l-.894-.15c-.542-.09-.94-.56-.94-1.11v-1.094c0-.55.398-1.02.94-1.11l.894-.149c.425-.07.765-.383.93-.78.165-.398.143-.854-.107-1.204l-.527-.738a1.125 1.125 0 0 1 .12-1.45l.773-.773a1.125 1.125 0 0 1 1.45-.12l.737.527c.35.25.807.272 1.204.107.397-.165.71-.505.78-.929l.15-.894Z"/></x-slot>
                    Announcements
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('student.subscriptions.index') }}" :active="request()->routeIs('student.subscriptions.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z"/></x-slot>
                    Subscription
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('student.referrals.index') }}" :active="request()->routeIs('student.referrals.*')">
                ...
                <x-sidebar-link href="{{ route('bundles.index') }}" :active="request()->routeIs('bundles.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 7.5-.625 10.5a.375.375 0 1 1 .75 0v-.001a.375.375 0 0 1-.75 0Zm0 4.875L19.125 15a.375.375 0 1 1 .75 0v-.001a.375.375 0 0 1-.75 0ZM3.375 16.5l1.5-1.5m9-1.5h-9L4.5 4.5l.75 1.5h13.5l-2.625 6.75m-9 0L11.25 9m-3.75 4.5L9 7.5"/></x-slot>
                    Bundles
                </x-sidebar-link>
                ...
                <x-sidebar-link href="{{ route('support.index') }}" :active="request()->routeIs('support.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z"/></x-slot>
                    Support
                </x-sidebar-link>
            ...
            @elseif($role === 'teacher')
                ...
                <x-sidebar-link href="{{ route('teacher.lesson-tracker') }}" :active="request()->routeIs('teacher.lesson-tracker*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z"/></x-slot>
                    Lesson Tracker
                </x-sidebar-link>
                ...
                <x-sidebar-link href="{{ route('teacher.policies.index') }}" :active="request()->routeIs('teacher.policies.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z"/></x-slot>
                    Policies & Contract
                </x-sidebar-link>
            ...
            @elseif($role === 'admin')
                ...
                <x-sidebar-link href="{{ route('admin.policies.index') }}" :active="request()->routeIs('admin.policies.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z"/></x-slot>
                    Policies & Contracts
                </x-sidebar-link>
                ...
                <x-sidebar-link href="{{ route('admin.coupons.index') }}" :active="request()->routeIs('admin.coupons.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z M6 6h.008v.008H6V6Z"/></x-slot>
                    Coupons
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('admin.refunds.index') }}" :active="request()->routeIs('admin.refunds.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3"/></x-slot>
                    Refund Requests
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('admin.bundles.index') }}" :active="request()->routeIs('admin.bundles.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 1 0 9.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1 1 14.625 7.5H12m0 0V21m-8.625-9.75h18c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125h-18c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z"/></x-slot>
                    Bundles
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('admin.plans.index') }}" :active="request()->routeIs('admin.plans.*')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z"/></x-slot>
                    Subscription Plans
                </x-sidebar-link>
                ...
                <p class="section-label px-3 pb-2 pt-3">Communication</p>
                <x-sidebar-link href="{{ route('admin.support.index') }}" :active="request()->routeIs('admin.support.index') || request()->routeIs('admin.support.show')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z"/></x-slot>
                    Support Inbox
                </x-sidebar-link>
                <x-sidebar-link href="{{ route('admin.support.email') }}" :active="request()->routeIs('admin.support.email')">
                    <x-slot name="icon"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"/></x-slot>
                    Compose Email
                </x-sidebar-link>
            @endif
    ...
    <div class="flex flex-col flex-1 min-w-0 lg:pl-64">
        ...
        <header class="sticky top-0 z-40 flex items-center gap-3 h-14 bg-white/95 backdrop-blur border-b border-slate-100 px-4 sm:px-6 flex-shrink-0">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2 lg:hidden">
                <img src="/logo.svg" alt="EduBridge" class="h-7 w-auto">
            </a>
