                ...
                <div class="grid sm:grid-cols-2 gap-5">
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price_usd" value="{{ old('price_usd', $course->price_usd) }}" min="0" step="0.01" class="form-input pl-7">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Price (ZWG)</label>
                        <input type="number" name="price_zwg" value="{{ old('price_zwg', $course->price_zwg) }}" min="0" step="0.01" class="form-input">
                    </div>
                </div>
            </div>
